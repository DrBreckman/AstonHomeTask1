...
public interface MyList<T> {
    ...
    /**
     * <p> Добавляет элемент в коллекцию на соответственную позицию.
    ...
    /**
     * Удаляет все элементы коллекции, оставляя текущий фактический размер коллекции.
     */
    void clear();
    ...
    /**
     * <p> Заменяет существующий элемент с заданным индексом на новый элемент. Если элемента с таким индексом нет,
